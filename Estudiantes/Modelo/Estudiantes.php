...
class Estudiantes extends Conexion
{
    ...
    {
        $statement = $this->db->prepare("INSERT INTO usuarios (NOMBRE, APELLIDO,DOCUMENTO,CORREO, MATERIA, DOCENTE, PROMEDIO, FECHA_REGISTRO)
    ...
    {
        $rows = null;
        $statement = $this->db->prepare("SELECT ID_ESTUDIANTE,NOMBRE, APELLIDO,DOCUMENTO,CORREO, MATERIA, DOCENTE, PROMEDIO, FECHA_REGISTRO
